...
<html style="font-size: 16px;" lang="es"><head>
        ...
        <meta charset="utf-8">
        <meta name="keywords" content="âMaking Your Business Ideas Come True, Welcome Message, The Future That YouWill See Soon, 92, 37, âOur Achievements, âOur Pricing, âSolo, âTeam, ââPreparing For Your Success,We Provide Truly Prominent IT Solutions., How Do We Help Companies To Transform?, âGet in touâch!">
    ...
    <body class="u-body u-white u-xl-mode" data-lang="es"><header class="u-black u-clearfix u-header" id="sec-888d" data-animation-name="" data-animation-duration="0" data-animation-delay="0" data-animation-direction=""><div class="u-clearfix u-sheet u-sheet-1">
                ...
                <div class="u-container-style u-grey-10 u-group u-group-1">
                    <div class="u-container-layout u-valign-top u-container-layout-1">
                        ...
                        <h4 class="u-align-center u-text u-text-2">Podemos implementar la seguridad enriqueciendo nuestros conocimients en base a la informacion que vamos adquiriendo en nuestros caminos en el internet<br>
                            <br>Mas que nadie, nosotros somos los encargados de Ã±Ã±evar nuestra propia seguridad en este universo que encontramos navegando por el internet, por este motivo los invitamos a seguir leyendo tan importante informacion
                        </h4>
                    </div>
                </div>
            </div>
        ...
        <section class="u-clearfix u-grey-10 u-section-2" id="sec-9da7">
            <div class="u-clearfix u-sheet u-valign-middle u-sheet-1">
                <div class="fr-view u-align-center u-clearfix u-rich-text u-text u-text-1" data-animation-name="" data-animation-duration="0" data-animation-direction="">
                    <h1 style="text-align: center;">Â¿Que son los antivirus?</h1>
                    <p style="text-align: center;">
                        <span style="font-size: 1.125rem;">Un antivirus es un tipo de software que se utiliza para evitar, buscar, detectar y eliminar virus de una computadora. Una vez instalados, la mayorÃ­a de los software antivirus se ejecutan automÃ¡ticamente en segundo plano para brindar protecciÃ³n en tiempo real contra ataques de virus.&nbsp;</span>
                        <span style="line-height: 2.0;">
                            <img src="../images/antivirus1.jpg" align="center" style="width: 379px;" class="fr-dib fr-fic" width="570">Con el paso del tiempo los sistemas operativos e internet han evolucionando, lo que ha hecho que los antivirus se actualicen constantemente, convirtiÃ©ndose en programas &nbsp;avanzados que no sÃ³lo detectan los virus, sino que los bloquean, desinfectan archivos y previenen infecciones de los mismos. Actualmente, los antivirus reconocen diferentes tipos de virus como malware, spyware, gusanos, troyanos, rootkits, etc. &nbsp;
                        </span>
                    </p>
                </div>
            </div>
                        ...
                        <div class="u-layout-row">
                            ...
                            <div class="u-container-style u-layout-cell u-size-47 u-white u-layout-cell-2">
                                <div class="u-container-layout u-container-layout-2">
                                    <h2 class="u-custom-font u-font-montserrat u-text u-text-1" data-lang-en="ââPreparing For Your Success,<br>We Provide Truly Prominent IT Solutions.">Tipos de antivirus</h2>
                                    <p class="u-text u-text-2" data-lang-en="âPodcasting operational change management inside of workflows to establish a framework. Taking seamless key performance indicators offline to maximise the long tail. Keeping your eye on the ball while performing a deep dive on the start-up mentality to derive convergence on cross-platform integration.&amp;nbsp;Objectively innovate empowered manufactured products whereas parallel platforms. Holisticly predominate extensible testing procedures for reliable supply chains. Dramatically engage top-line web services vis-a-vis cutting-edge deliverables. Image from <a href=&quot;https://www.freepik.com&quot; class=&quot;u-active-none u-border-none u-btn u-button-link u-button-style u-hover-none u-none u-text-palette-1-base u-image-1&quot; style=&quot;background-image: none; padding-top: 0; padding-bottom: 0; padding-left: 0; padding-right: 0&quot;>Freepik</a>"> Hoy en dÃ­a nadie duda de la importancia de contar con un antivirus fiable y actualizado que proteja a tu ordenador de posibles ataques, pero dependiendo de quÃ©&nbsp;tipo de antivirus&nbsp;tengas instalado en tu equipo, tendrÃ¡s una mejor o peor seguridad.<br>
                                        <br>En este artÃ­culo vas a comprobar que existen muchos&nbsp;tipos de antivirus&nbsp;y para mostrÃ¡rtelos, vamos a clasificarlos segÃºn diferentes criterios como son: su finalidad, segÃºn si estÃ¡n creados para cumplir con un objetivo especÃ­fico, segÃºn cÃ³mo se ejecutan y segÃºn su marca.
                                    </p>
                                </div>
                            </div>
                        </div>
        ...
        <section class="u-align-left u-clearfix u-section-4" id="sec-148a">
            <div class="u-clearfix u-sheet u-sheet-1">
                <div class="fr-view u-clearfix u-rich-text u-text u-text-1">
                    ...
                    <p id="isPasted">
                        <span style="font-weight: 700;">ANTIVIRUS PREVENTORES:</span> como su nombre lo indica, este tipo de antivirus se caracteriza por anticiparse a la infecciÃ³n, previniÃ©ndola. De esta manera, permanecen en la memoria de la computadora, monitoreando ciertas acciones y funciones del sistema.
                    </p>
                    <p>
                        <span style="font-weight: 700;">ANTIVIRUS IDENTIFICADORES:</span> esta clase de antivirus tiene la funciÃ³n de identificar determinados programas infecciosos que afectan al sistema. Los virus identificadores tambiÃ©n rastrean secuencias de bytes de cÃ³digos especÃ­ficos vinculados con dichos virus.
                    </p>
                    <p>
                        <span style="font-weight: 700;">ANTIVIRUS DESCONTAMINADORES:</span> comparte una serie de caracterÃ­sticas con los identificadores. Sin embargo, su principal diferencia radica en el hecho de que el propÃ³sito de esta clase de antivirus es descontaminar un sistema que fue infectado, a travÃ©s de la eliminaciÃ³n de programas malignos. El objetivo es retornar dicho sistema al estado en que se encontraba antes de ser atacado. Es por ello que debe contar con una &nbsp;exactitud en la detecciÃ³n de los programas malignos.&nbsp;
                    </p>
                    <p>Otra manera de clasificar a los antivirus es la que se detalla a continuaciÃ³n:</p>
                    <p>
                        <span style="font-weight: 700;">CORTAFUEGOS O FIREWALL:</span> estos programas tienen la funciÃ³n de bloquear el acceso a un determinado sistema, actuando como muro defensivo. Tienen bajo su control el trÃ¡fico de entrada y salida de una computadora, impidiendo la ejecuciÃ³n de toda actividad dudosa.
                    </p>
                    <p>
                        <span style="font-weight: 700;">ANTIESPÃAS O ANTISPYWARE:</span> esta clase de antivrus tiene el objetivo de descubrir y descartar aquellos programas espÃ­as que se ubican en la computadora de manera oculta.
                    </p>
                    <p>
                    ...
                    <p>
                        <span style="font-weight: 700;">ANTISPAM:</span> se denomina spam a los mensajes basura, no deseados o que son enviados desde una direcciÃ³n desconocida por el usuario. Los antispam tienen el objetivo de detectar esta clase de mensajes y eliminarlos de forma automÃ¡tica.
                    </p>
                </div>
            </div>
        </section>
        ...
        <section class="u-backlink u-clearfix u-grey-80">
            ...
            <style> .u-cookies-consent {
                ...
                %>
        <script>
    console.log('EstadÃ­stica registrada: ' +<%=stat.getStatus()%>);
        </script>
    </body></html>
